...
Status: **Archived** post-v1 plan (shipped). Move/translate remain intentional backlog.
Supersedes: [2026-07-greenfield-implementation-plan.md](./2026-07-greenfield-implementation-plan.md)
Authoritative behavior today: [README.md](../../README.md), [docs/contract-v1.md](../contract-v1.md), [docs/protocol.md](../protocol.md), [docs/design/](../design/)
Post-v1 ground truth: [docs/contract-v2.md](../contract-v2.md), [docs/research-post-v1-seams.md](../research-post-v1-seams.md), [docs/schemas/](../schemas/)
Next planning topic: agent/robot CLI UX — see root [IMPLEMENTATION_PLAN.md](../../IMPLEMENTATION_PLAN.md) stub and [docs/design/robot-cli.md](../design/robot-cli.md) (when present).
